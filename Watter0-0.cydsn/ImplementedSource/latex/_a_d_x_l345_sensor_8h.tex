...
This header includes necessary structs and functions to communicate with an A\+D\+X\+L345 accelerometer over I2C.  
...
\begin{DoxyCompactList}\small\item\em Calculates the revolutions pr. minute. \end{DoxyCompactList}\item 
...
Calculates the revolutions pr. minute. 

This function uses both \doxyref{average()}{p.}{_a_d_x_l345_sensor_8h_a8e22aff3a9b47ba2881baef447e63b67} and \doxyref{delta\+Axis2\+Deg()}{p.}{_a_d_x_l345_sensor_8h_a5ae619ca837b5e93cc930fec17ec29d8} to return an average revolutions pr. minute. by using timed interrupt and a single measurement dataset.


\begin{DoxyParams}{Parameters}
{\em x} & The momentary value of the X Axis. \\
\hline
{\em y} & The momentary value of the y Axis. \\
\hline
{\em z} & The momentary value of the Z Axis. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
float a average revolutions pr. minute. 
\end{DoxyReturn}
